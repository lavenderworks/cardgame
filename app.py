...
function confirmLeaveLobby() {
  if (!confirm("Möchtest du wirklich zur Lobby zurück? Dein Platz wird bis zum Ende vom Bot übernommen.")) return;
  send("leave_lobby");
}
        ...
        while True:
            ...
            # ------------------------------------------------
                ...
                if room and player_id:
                    ...
                    if room.game.phase not in ("lobby", "game_over"):
